				...
				<div class="card-body">
					...
					<input type="hidden" name="id" value="${currCat.getId()}">
						<div class="input-group form-group">
							...
							<input name="categoryName" value="${currCat.getName()}" class="form-control"
						...
						<div class="input-group form-group">
							...
							<input name="categoryDescription" value="${currCat.getDescription()}" class="form-control"
